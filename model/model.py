...
class Model:
    ...
    """
    fillDD classic
    Query per gli archi con input paese, anno, idMap che restituisce già la lista corretta degli archi.
    Per la somma dei pesi degli archi di un nodo guarda il metodo: computeVolume(self).
    """